...
import org.openapitools.client.models.RemoveOptionFromIssuesResult
...
data class TaskProgressBeanRemoveOptionFromIssuesResult (
    ...
    @Json(name = "status")
    val status: TaskProgressBeanRemoveOptionFromIssuesResult.Status,
    ...
    @Json(name = "result")
    val result: RemoveOptionFromIssuesResult? = null,
