...
import org.openapitools.client.models.CustomFieldOptionDetails
...
data class PageBeanCustomFieldOptionDetails (
    /* The URL of the page. */
    @Json(name = "self")
    ...
    /* The list of items. */
    @Json(name = "values")
    val values: kotlin.Array<CustomFieldOptionDetails>? = null
) 
