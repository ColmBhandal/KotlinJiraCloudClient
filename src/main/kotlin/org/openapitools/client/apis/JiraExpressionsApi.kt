...
import org.openapitools.client.models.JiraExpressionEvalRequestBean
import org.openapitools.client.models.JiraExpressionForAnalysis
import org.openapitools.client.models.JiraExpressionResult
import org.openapitools.client.models.JiraExpressionsAnalysis
...
class JiraExpressionsApi(basePath: kotlin.String = "http://localhost") : ApiClient(basePath) {
    ...
    */
    ...
    fun comAtlassianJiraRestV2ExpressionJiraExpressionsResourceAnalyseExpressionPost(jiraExpressionForAnalysis: JiraExpressionForAnalysis) : JiraExpressionsAnalysis {
        val localVariableBody: kotlin.Any? = jiraExpressionForAnalysis
        ...
        val localVarResponse = request<JiraExpressionsAnalysis>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as JiraExpressionsAnalysis
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun comAtlassianJiraRestV2ExpressionJiraExpressionsResourceEvaluateJiraExpressionPost(jiraExpressionEvalRequestBean: JiraExpressionEvalRequestBean, expand: kotlin.String?) : JiraExpressionResult {
        val localVariableBody: kotlin.Any? = jiraExpressionEvalRequestBean
        ...
        val localVarResponse = request<JiraExpressionResult>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as JiraExpressionResult
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
