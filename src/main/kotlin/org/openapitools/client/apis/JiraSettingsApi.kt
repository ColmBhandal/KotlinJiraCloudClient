...
import org.openapitools.client.models.ApplicationProperty
import org.openapitools.client.models.Configuration
import org.openapitools.client.models.SimpleApplicationPropertyBean
...
class JiraSettingsApi(basePath: kotlin.String = "http://localhost") : ApiClient(basePath) {
    ...
    * @return kotlin.Array<ApplicationProperty>
    ...
    */
    ...
    fun comAtlassianJiraRestV2AdminApplicationPropertiesResourceGetAdvancedSettingsGet() : kotlin.Array<ApplicationProperty> {
        ...
        val localVarResponse = request<kotlin.Array<ApplicationProperty>>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.Array<ApplicationProperty>
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun comAtlassianJiraRestV2AdminApplicationPropertiesResourceGetApplicationPropertyGet(key: kotlin.String?, permissionLevel: kotlin.String?, keyFilter: kotlin.String?) : kotlin.Array<ApplicationProperty> {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                ...
                if (permissionLevel != null) {
                    put("permissionLevel", listOf(permissionLevel.toString()))
                }
                if (keyFilter != null) {
                    put("keyFilter", listOf(keyFilter.toString()))
                }
            }
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun comAtlassianJiraRestV2AdminApplicationPropertiesResourceSetApplicationPropertyPut(id: kotlin.String, simpleApplicationPropertyBean: SimpleApplicationPropertyBean) : ApplicationProperty {
        val localVariableBody: kotlin.Any? = simpleApplicationPropertyBean
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.PUT,
            "/rest/api/3/application-properties/{id}".replace("{"+"id"+"}", "$id"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val localVarResponse = request<ApplicationProperty>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as ApplicationProperty
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun comAtlassianJiraRestV2AdminConfigurationResourceGetConfigurationGet() : Configuration {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
        ...
        val localVarResponse = request<Configuration>(
            localVariableConfig,
            localVariableBody
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as Configuration
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
